    ...
    *result = 0;
    ...
    while (true) {
        ...
        if (model && (*result != 2)) {
            ...
            //if (!clingo_control_new(NULL, 0, NULL, NULL, 20, &ctl_second_lvl) != 0) { goto error; }

            if (!set_answerset_model_as_facts(ctl_second_lvl, model)) { goto error; };

            

            //if (!clingo_control_load(ctl_second_lvl, file)) { goto error; }
...
double main(int argc, char const** argv) {
    ...
    //if (!clingo_control_load(ctl, asp_file_input_target)) { goto error; }
    ...
    clingo_part_t parts_second_lvl[] = { { "completion", NULL, 0 }, { "extension", NULL, 0 }, { "skeptical", NULL, 0 }, { "filter_complete", NULL, 0 } };
